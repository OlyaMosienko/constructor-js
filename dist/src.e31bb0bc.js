...
exports.TitleBlock = exports.TextBlock = exports.ImgBlock = exports.ColumnsBlock = void 0;
...
var TextBlock = exports.TextBlock = /*#__PURE__*/function (_Block2) {
...
var ImgBlock = exports.ImgBlock = /*#__PURE__*/function (_Block4) {
  function ImgBlock(value, options) {
    _classCallCheck(this, ImgBlock);
    return _callSuper(this, ImgBlock, [value, options]);
  }
  _inherits(ImgBlock, _Block4);
  return _createClass(ImgBlock, [{
    key: "toHTML",
    value: function toHTML() {
...
},{"../utils":"utils.js"}],"assets/cat.jpg":[function(require,module,exports) {
module.exports = "/cat.ed45fa99.jpg";
...
var _cat = _interopRequireDefault(require("./assets/cat.jpg"));
...
}), new _blocks.ImgBlock(_cat.default, {
  styles: {
    display: 'flex',
...
}), new _blocks.ColumnsBlock(['1111111111', '2222222222', '3333333333'], {
  styles: {
    padding: '2rem',
    'font-weight': 'bold',
...
},{"./classes/blocks":"classes/blocks.js","./assets/cat.jpg":"assets/cat.jpg"}],"classes/site.js":[function(require,module,exports) {
"use strict";
